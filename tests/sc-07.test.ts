...
/**
 * Verify sc-07.csv Java → pseudocode conversions.
 */
test("sc-07.csv cases", () => {
  for (const { input, expected } of loadCsvCases("sc-07.csv")) {
    const result = convert(input, { style: "sc-07" });
