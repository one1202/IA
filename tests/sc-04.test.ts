...
/**
 * Verify sc-04.csv Java → pseudocode conversions.
 */
test("sc-04.csv cases", () => {
  for (const { input, expected } of loadCsvCases("sc-04.csv")) {
    const result = convert(input, { style: "sc-04" });
