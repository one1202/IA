...
/**
 * Verify sc-06.csv Java → pseudocode conversions.
 */
test("sc-06.csv cases", () => {
  for (const { input, expected } of loadCsvCases("sc-06.csv")) {
    const result = convert(input, { style: "sc-06" });
