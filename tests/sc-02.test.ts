...
/**
 * Verify sc-02.csv Java → pseudocode conversions.
 */
test("sc-02.csv cases", () => {
  for (const { input, expected } of loadCsvCases("sc-02.csv")) {
    const result = convert(input, { style: "sc-02" });
