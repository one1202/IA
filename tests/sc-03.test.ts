...
/**
 * Verify sc-03.csv Java → pseudocode conversions.
 */
test("sc-03.csv cases", () => {
  for (const { input, expected } of loadCsvCases("sc-03.csv")) {
    const result = convert(input, { style: "sc-03" });
