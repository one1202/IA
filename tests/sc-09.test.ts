...
/**
 * Verify sc-09.csv Java → pseudocode conversions.
 */
test("sc-09.csv cases", () => {
  for (const { input, expected } of loadCsvCases("sc-09.csv")) {
    const result = convert(input, { style: "sc-09" });
