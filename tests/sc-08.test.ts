...
/**
 * Verify sc-08.csv Java → pseudocode conversions.
 */
test("sc-08.csv cases", () => {
  for (const { input, expected } of loadCsvCases("sc-08.csv")) {
    const result = convert(input, { style: "sc-08" });
